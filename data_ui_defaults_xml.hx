...
ru.stablex.ui.UIBuilder.defaults.get("VBox").set("EditorMenu", function(__ui__widget0:ru.stablex.ui.widgets.Widget) : Void {
var __ui__widget1 : ru.stablex.ui.widgets.VBox = cast(__ui__widget0, ru.stablex.ui.widgets.VBox);
__ui__widget1.paddingBottom = 10;
__ui__widget1.skinName = 'EditorPanel';
});
ru.stablex.ui.UIBuilder.defaults.get("VBox").set("EditorWidgetProperties", function(__ui__widget0:ru.stablex.ui.widgets.Widget) : Void {
var __ui__widget1 : ru.stablex.ui.widgets.VBox = cast(__ui__widget0, ru.stablex.ui.widgets.VBox);
...
ru.stablex.ui.UIBuilder.defaults.get("Text").set("EditorHeading", function(__ui__widget0:ru.stablex.ui.widgets.Widget) : Void {
var __ui__widget1 : ru.stablex.ui.widgets.Text = cast(__ui__widget0, ru.stablex.ui.widgets.Text);
__ui__widget1.format.font = ru.stablex.Assets.getFont('fonts/CONSOLA.TTF').fontName;
__ui__widget1.format.size = 18;
__ui__widget1.label.embedFonts = true;
__ui__widget1.skinName = 'EditorHeadingSkin';
__ui__widget1.label.selectable = false;
});
...
ru.stablex.ui.UIBuilder.defaults.get("Button").set("EditorButton", function(__ui__widget0:ru.stablex.ui.widgets.Widget) : Void {
var __ui__widget1 : ru.stablex.ui.widgets.Button = cast(__ui__widget0, ru.stablex.ui.widgets.Button);
__ui__widget1.format.color = 0xcdc4d9  ;
__ui__widget1.format.font = ru.stablex.Assets.getFont('fonts/CONSOLA.TTF').fontName;
__ui__widget1.format.size = 14;
...
ru.stablex.ui.UIBuilder.defaults.get("Button").set("EditorMenu", function(__ui__widget0:ru.stablex.ui.widgets.Widget) : Void {
var __ui__widget1 : ru.stablex.ui.widgets.Button = cast(__ui__widget0, ru.stablex.ui.widgets.Button);
__ui__widget1.format.color = 0xcdc4d9;
__ui__widget1.format.font = ru.stablex.Assets.getFont('fonts/CONSOLA.TTF').fontName;
__ui__widget1.format.size = 14;
...
ru.stablex.ui.UIBuilder.defaults.get("TabPage").set("EditorMenu", function(__ui__widget0:ru.stablex.ui.widgets.Widget) : Void {
var __ui__widget1 : ru.stablex.ui.widgets.TabPage = cast(__ui__widget0, ru.stablex.ui.widgets.TabPage);
__ui__widget1.title.label.autoSize = openfl.text.TextFieldAutoSize.LEFT;
__ui__widget1.title.label.selectable = false;
__ui__widget1.title.format.align = openfl.text.TextFormatAlign.LEFT;
__ui__widget1.title.h = 50;
__ui__widget1.title.w = 100;
__ui__widget1.title.label.mouseEnabled = false;
__ui__widget1.title.skinName = 'EditorMenuTab';
__ui__widget1.title.format.color = 0xcdc4d9  ;
__ui__widget1.title.format.font = ru.stablex.Assets.getFont('fonts/CONSOLA.TTF').fontName;
__ui__widget1.title.label.embedFonts = true;
__ui__widget1.title.format.size = 14;
});})()